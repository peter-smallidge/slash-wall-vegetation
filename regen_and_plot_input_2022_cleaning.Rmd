...
# need to change the df to /old files but do not discard/slash.wall.data.2022.15february2025.xlsx
...
plot_data01  <- read_excel("~/R/slash-wall-vegetation/slash.wall.data.2022.16may2023_final.xlsx", 
  ...
  mutate(spp = "004", origin = "s") %>% 
        # (5/29/2025, I'm not sure what this does. Creates a new variable spp and sets it equal to "004".
        # and a new variable origin and sets in equal to "s".)
  mutate(
    location = as.character(location),
    point = as.character(point)
) %>% 
