...
1. df "summary_regen_veg_data.Rmd" reads data through the output of June 2023.  Likely through the 2022 growing season. This effort is redundant with #7 below.
