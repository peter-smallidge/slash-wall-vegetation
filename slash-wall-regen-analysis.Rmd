...
point.count <-  regen.per.acre %>% # create variable for total plots for denominator of average density
...
write_csv( "diversity-acre-point.csv")

###   calculations at point-level were confirmed for boot>interior>#350, #355 and #361
