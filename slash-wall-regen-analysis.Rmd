...
### Convert plot seedling counts to per acre values

```{r}
# convert seedling counts to per acre values
# 1. convert missting (NA) to 0 else density values inflated
# 2. multiple *.seed01 x 1000 (radius 3.7 ft). use mutate
# 3. multiple *. x (radius = 6) use mutate
# 4. aggregate into all suppressed and all exposed and top4 per acre
...
# 
# desirable diversity species (no interfering)
