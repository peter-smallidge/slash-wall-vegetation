...
# 
# The source file is from slash_veg_complete.Rmd df = yay2_harvest will incorporate the 2024 growing season data.
# 
...
```{r}
#complete data
file_path_veg_complete <- "C:\\Users\\pjs23\\Documents\\R\\slash-wall-vegetation\\summary output\\veg_data_2019to2024_complete(30july2025)(readme).xlsx"
...
output_file <- file.path(output_folder, paste0("sample_size_table(27may2025)", ".xlsx"))
