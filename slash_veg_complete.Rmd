...
point_labels_revision <- read_excel(file_path_points, sheet = "Sheet1", skip = 0) %>% 
...
#create "comm_sdl by adding supA+expA for commercial species
  mutate(seedA = case_when(
    type == "commercial" ~ supA + expA,
    TRUE ~ NA_real_
  )) %>% 

#create metric for number of clumps by species
